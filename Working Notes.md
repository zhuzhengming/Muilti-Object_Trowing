...
Timeline, …… (why experiment? never use)
...
Next part is some experiment result. **Under predefined grasping posture,** the delay is around **40-50 ms**. Then here is a video about **reactive throwing** on real robot, I changed the target position randomly. It can alway generate a good trajectory and throw into the box as long as within the **reachable space**. 
