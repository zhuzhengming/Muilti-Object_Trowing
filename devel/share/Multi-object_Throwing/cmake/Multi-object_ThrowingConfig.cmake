...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'Multi-object_Throwing' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/zhengmingzhu/workspace/Muilti-Object_Trowing/src/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/zhengmingzhu/workspace/Muilti-Object_Trowing/devel/lib;/opt/ros/noetic/lib)
